...
describe('Transaction Pool Interface', () => {
	...
	describe('getTransactionsForForging', () => {
		...
		it('should throw an exception', async () => {
			await expect(poolInterface.getTransactionsForForging()).rejects.toThrowError(
	...
	describe('getTransactionIdsForForging', () => {
		...
		it('should throw an exception', async () => {
			await expect(poolInterface.getTransactionIdsForForging()).rejects.toThrowError(
	...
	describe('checkIfSenderHasVoteTransactions', () => {
		...
		it('should throw an exception', async () => {
			expect(poolInterface.checkIfSenderHasVoteTransactions).toThrowError(
				'Method [checkIfSenderHasVoteTransactions] not implemented!',
			)
		})
	})
