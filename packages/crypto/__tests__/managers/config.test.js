...
describe('Configuration', () => {
	...
	it('should build dynamic fee offsets', () => {
		...
		expect(dynamicFeeManager.get(TRANSACTION_TYPES.DELEGATE_REGISTRATION)).toEqual(
			dynamicOffsets.delegateRegistration,
		)
		...
		expect(dynamicFeeManager.get(TRANSACTION_TYPES.DELEGATE_RESIGNATION)).toEqual(
			dynamicOffsets.delegateResignation,
		)
	})
